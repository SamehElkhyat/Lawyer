      ...
      <div className="w-full max-w-md relative">
        ...
        <div className="bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden">
          ...
          <div className="bg-gradient-to-l from-emerald-600 to-teal-700 p-8 text-center relative">
            ...
            <div className="relative z-10">
              <div className="w-16 h-16 mx-auto mb-4 bg-white/20 rounded-2xl flex items-center justify-center backdrop-blur-sm border border-white/20">
                <Image src="/justice-scale.png" alt="National Access" width={32} height={32} className="brightness-0 invert" />
              </div>
              ...
              <p className="text-emerald-100 text-sm leading-relaxed">
                تسجيل الدخول بحساب نافذ يتطلب تحميل تطبيق "نافذ" من متجر التطبيقات وفتح من
                أجل التدقق الآمن لهويتك الرقمية
              </p>
            </div>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  >
                    {showPassword ? (
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.878 9.878L5.636 5.636m4.242 4.242L15.122 15.122m-4.242-4.242L5.636 5.636m9.486 9.486L19.364 19.364M15.122 15.122L5.636 5.636" />
                      </svg>
                    ) : (
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="relative my-8">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-4 bg-white text-gray-500">أو عن طريق</span>
                </div>
              </div>
          ...
          <div className="px-8 pb-8 pt-4 border-t border-gray-100 bg-gray-50/50">
            <div className="text-center space-y-3">
              <Link href="/forgot-password" className="text-emerald-600 hover:text-emerald-700 text-sm font-medium transition-colors block">
                نسيت كلمة المرور؟
              </Link>
              
              <Link href="/register" className="text-gray-600 hover:text-gray-700 text-sm transition-colors block">
                ليس لديك حساب؟ 
                <span className="text-emerald-600 font-semibold mr-1">إنشاء حساب جديد</span>
              </Link>
        ...
        <div className="mt-6 text-center">
          <div className="inline-flex items-center space-x-2 space-x-reverse bg-white/80 backdrop-blur-sm rounded-full px-4 py-2 border border-gray-200 shadow-sm">
            ...
            <span className="text-xs text-gray-600 font-medium">محمي بتشفير SSL</span>
          </div>
        </div>
